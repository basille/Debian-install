...
echo "deb http://cloud.r-project.org/bin/linux/debian bookworm-cran40/" | sudo
tee /etc/apt/sources.list.d/r.list
# QGIS
sudo wget -P /etc/apt/keyrings/ https://download.qgis.org/downloads/qgis-archive-keyring.gpg
echo "Types: deb deb-src\nURIs: https://qgis.org/debian\nSuites: bookworm\nArchitectures: amd64\nComponents: main\nSigned-By: /etc/apt/keyrings/qgis-archive-keyring.gpg"  | sudo
tee /etc/apt/sources.list.d/qgis.sources
#+end_src
